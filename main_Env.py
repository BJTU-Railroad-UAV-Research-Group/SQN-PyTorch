...
parser.add_argument('--log_dir', default='/data1/mengfanteng/SQN_exp/Env', help='Dump dir to save model checkpoint [default: log]')
...
def train_one_epoch():
    ...
    for batch_idx, batch_data in enumerate(training_dataloader):
        ...
        # Forward pass
        optimizer.zero_grad()
        end_points = net(batch_data, is_training=True)
        end_points['batch_anno_labels'] = torch.cat([batch_data['batch_anno_labels'], batch_data['batch_anno_labels']], dim=0)
