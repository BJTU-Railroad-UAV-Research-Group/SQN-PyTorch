...
class ConfigEnv:
    ...
    train_sum_dir = 'train_log'
    saving = True
    saving_path = "/data1/mengfanteng/SQN_exp/Env"
    ignored_labels = np.array([0]) 

    ## 
    name = 'Env'
    dataset_dir = '/data1/mengfanteng/dataset/ENVPC_dataset/20241129_MYEnv_PC'
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        elif dataset_name == 'Env':
            num_per_class = np.array([99745, 210610, 9588, 53965, 10404634, 747051, 81161, 3336,
                                        150497, 12731, 43999])
